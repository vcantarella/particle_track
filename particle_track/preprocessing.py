...
def prepare_arrays(gwfmodel, model_directory, porosity=0.3):
    ...
    all_faces[0] = all_faces[0] / row_area / porosity
    all_faces[1] = all_faces[1] / row_area / porosity
    all_faces[2] = all_faces[2] / col_area / porosity
    all_faces[3] = all_faces[3] / col_area / porosity
    all_faces[4] = all_faces[4] / top_area / porosity
    all_faces[5] = all_faces[5] / top_area / porosity
...
def prepare_arrays_cuda(gwfmodel, model_directory, porosity=0.3):
    """
    EDIT this to make sure you add the Boundary conditions in the right faces!!
    Parameters
    ----------
    ...
    return xedges, yedges, z_lf, z_uf, face_velocities, termination