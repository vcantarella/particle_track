...
@numba.vectorize([float64(int64, boolean, float64, float64, float64, float64, float64, float64, float64)], nopython = True)
...
def trajectory(initial_position, initial_cell, face_velocities, gvs, xedges, yedges, z_lf, z_uf, termination):
    ...
    while termination_criteria:
        ...
        exit_point = exit_location(exit_direction_index,velocity_gradient_index,dt,v0,v1,v,gvp,coords,coords_0,coords_1)
